      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden">
          ...
          <div className="space-y-6 text-gray-700">
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-400 rounded-lg p-4">
              <div className="flex items-center mb-3">
                ...
                <h2 className="text-xl font-bold text-green-800">Educational Research Project</h2>
              </div>
              <p className="text-sm text-green-700">
                This platform is a <strong>virtual social experiment</strong> designed to study online behavior, 
                community dynamics, and digital interaction patterns in a safe, controlled environment.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2">Community Experiment</h3>
                  <p className="text-sm text-gray-600">
                    Join thousands of users in this unique digital sociology study. 
                    Observe how virtual communities form, interact, and evolve over time.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2">100% Virtual & Safe</h3>
                  <p className="text-sm text-gray-600">
                    All activities are purely symbolic and digital. This is a simulation - 
                    no real countries, governments, or individuals are involved in any way.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-2">Research Purpose</h3>
                  <p className="text-sm text-gray-600">
                    Data collected helps researchers understand online behavior patterns, 
                    community formation, and digital social dynamics.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Academic Context:</strong> This research contributes to understanding digital communities 
                and online social behavior. Results may be published in academic journals with full anonymization.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-6 border-t">
          ...
          <p className="text-xs text-gray-500 text-center mt-4">
            By clicking "Join the Experiment!", you acknowledge that you have read and understood this disclaimer.
          </p>
        </div>
      </div>
    </div>
